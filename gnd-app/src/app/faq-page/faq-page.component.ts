...
export class FaqPageComponent {
  ...
  leftFaqs = [
    ...
    { id: 'faq5', question: 'What types of files can I upload to GND?', answer: 'GND supports a variety of file types, including PDF, Excel, and Word.' },
    ...
    { id: 'faq8', question: 'Is there a tutorial on how to use GND?', answer: 'Yes, GND includes a help button that provides a comprehensive tutorial on how to use the app. The tutorial covers everything from uploading files to understanding the scan results.' },
    ...
    { id: 'faq10', question: 'How do I interpret the scanned results?', answer: 'The scan results will highlight any detected GDPR violations and provide details on the nature of each violation. The report will include recommendations for addressing these issues to help you achieve compliance.' },
