...
//     // Handle the initial GET request made in ngOnInit
//     const req1 = httpMock.expectOne('http://127.0.0.1:8000/get-data-folder');
//     expect(req1.request.method).toBe('GET');
//     req1.flush({ outlook_data_folder: 'test/folder' });

//     // Handle the GET request made in getReports()
//     const req2 = httpMock.expectOne('http://127.0.0.1:8000/outlook-results');
//     expect(req2.request.method).toBe('GET');
//     req2.flush([]); // Provide mock data as needed
//   });
...
//     // The HTTP requests are already handled in beforeEach
...
//   it('should extract country from file name', () => {
//     expect(component.extractCountryFromFileName('Report - USA.pdf')).toBe('USA');
//     expect(component.extractCountryFromFileName('Invalid')).toBe('Not Available');
//   });
...
//   // Example of handling additional HTTP requests in specific tests
//   it('should get report content correctly', () => {
...
//     req.flush({ content: "{ 'result': { 'score': { 'Status': 0.5, 'NER': 10, 'Personal': 5, 'Financial': 2, 'Contact': 1, 'Medical': 0, 'Ethnic': 0, 'Biometric': 0, 'Genetic': 0, 'Consent Agreement': true, 'RAG_Statement': 'Green' } } }" });
